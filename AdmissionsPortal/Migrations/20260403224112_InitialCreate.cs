        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinGPA = table.Column<decimal>(type: "TEXT", nullable: false),
                    MinYears = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MasterPrograms_Universities_UniversityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudyYears = table.Column<int>(type: "INTEGER", nullable: false),
                    DiplomaStatus = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Universities",
                columns: new[] { "Id", "MinGPA", "MinYears", "Name" },
                values: new object[,]
                {
                    { 1, 2.5m, 3, "University of Tirana" },
                    { 2, 3.0m, 3, "Polytechnic University" },
                    { 3, 2.8m, 3, "European University of Tirana" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_MasterProgramId",
                table: "Applications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MasterPrograms_UniversityId",
                table: "MasterPrograms",
                column: "UniversityId");
        }
